            ...
            {item.hasDropdown ? (
              <div className="my-2">
                ...
                <button
                  ...
                  className="flex items-center justify-between w-full px-3 py-2 rounded-lg text-gray-800 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors font-medium"
                >
