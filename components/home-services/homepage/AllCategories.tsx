            ...
            {subcategories.map(
              ({ id, name, Icon, count, color, iconColor, hoverColor }) => (
                ...
                >
                  ...
                  >
                    <div className="h-30 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-2 rounded-xl flex flex-col items-center text-center hover:border-sky-300 dark:hover:border-sky-500 transition-all duration-300 shadow-sm hover:shadow-md">
                      {/* Icon with gradient background */}
                      <div
                        className={`mb-1 p-2 rounded-lg ${color} ${hoverColor} transition-all duration-500 group-hover:scale-110`}
                      >
                        {" "}
                        {/* Smaller rounded-lg */}
                        <Icon
