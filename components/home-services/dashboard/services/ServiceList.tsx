  ...
  useEffect(() => {
    if (data?.services?.services) {
      const transformed = data.services.services.map((service: Service): TransformedService => {
        ...
        // Determine if service is completed based on your business logic
        ...
        return {
          ...
          metrics: {
            spent: "0", // You can calculate this from your actual data
            leads: service.totalLeads || 0,
            views: 0 // Add actual views data if available
          },
          setupProgress: {
  ...
  const toggleService = (id: string) => {
    setTransformedServices(prevServices =>
      prevServices.map(service =>
        service.id === id ? {
          ...service,
          active: service.completed ? !service.active : false
        } : service
      )
    );
          ...
          {transformedServices.length === 0 ? (
            ...
            transformedServices.map((service) => (
              ...
              >
                {/* Service Header */}
                <div
                  className="cursor-pointer transition-colors hover:bg-gray-50 dark:hover:bg-gray-700 bg-white dark:bg-gray-800"
                    ...
                    <div className="flex items-center justify-between gap-2">
                      <div className="space-y-1 flex-1 min-w-0">
                        <div className="flex items-center gap-2 flex-wrap">
                          <h2 className="font-semibold text-gray-900 dark:text-white truncate text-[13px]">
                            {service.name}
                          </h2>
                          {!service.completed && (
                        ...
                        <p className="text-gray-600 dark:text-gray-300 truncate text-[12px]">
                          {service.description}
                        </p>
                      </div>
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        <button
                          ...
                          className={`relative inline-flex flex-shrink-0 h-5 w-9 rounded-full transition-colors ${
                            ...
                            !service.completed ? 'opacity-50 cursor-not-allowed' : ''
                          }`}
                        >
                          <span
                ...
                <AnimatePresence>
                  {expandedId === service.id && (
                    <motion.div
                      ...
                      className="px-3 pb-4 bg-white dark:bg-gray-800"
                    >
                      <div className="pt-3 border-t border-gray-200 dark:border-gray-600">
                        <div className="space-y-4">
                          ...
                          {/* Activity Metrics */}
                          <div id="metrics">
                            <h3 className="font-semibold mb-3 text-gray-900 dark:text-white text-[13px]">
                              Activity this week
                            </h3>
                            ...
                            <div className="grid grid-cols-2 gap-2 mb-3">
                              <div className={`border rounded-sm p-2 text-center transition-all ${
                                ...
                                <Link
                                  ...
                                  className="text-[11px] mt-0.5 inline-flex items-center justify-center gap-0.5 text-[#0077B6] dark:text-[#0077B6]"
                                >
                          ...
                          <div id="pricing">
                            ...
                            <div className="border rounded-sm p-3 bg-gray-50 dark:bg-gray-700">
                              <div className="flex items-center justify-between">
                                <div>
                                  <p className="font-medium text-gray-900 dark:text-white text-[13px]">
                          ...
                          <div className="flex flex-col-reverse sm:flex-row sm:justify-between sm:items-center gap-3">
                            ...
                            <div className="flex justify-end">
                              <button
                                ...
                                className="inline-flex items-center px-3 py-1.5 border border-transparent font-medium rounded-md focus:outline-none focus:ring-1 focus:ring-offset-1 transition bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/30 text-[12px]"
                              >
                                Remove service
                              </button>
