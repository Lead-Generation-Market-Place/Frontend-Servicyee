    ...
    <>
      ...
      <div className="dark:bg-gray-900 p-2 lg:p-2">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
            <h3 className="text-sm text-gray-500">Incomplete Setups</h3>
            <p className="text-2xl font-bold text-[#0077B6]">
              2
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto space-y-4">
          {/* Header */}
          <header className="animate-fade-in-up flex justify-between items-start">
            <div>
            ...
            <Link href="/home-services/dashboard/services/businessAvailability" className="text-[#0077B6] dark:text-[#48CAE4] text-[12px] hover:underline">Business Availability</Link>
          </header>
