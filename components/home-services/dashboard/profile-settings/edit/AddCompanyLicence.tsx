...
const AddCompanyLicence = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto p-4">
        ...
        <>
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
              ...
              documentation from you. Select the option that best describes what
              you need help with.
            </p>
          </div>
              ...
              <div className="flex items-start space-x-3 p-4 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-sky-300 dark:hover:border-sky-500 transition-colors">
                ...
                <div className="flex-1">
                  <Label
                    ...
                    className="text-base font-medium text-gray-800 dark:text-gray-200 cursor-pointer"
                  >
                    Account that was removed because I&apos;m believed to be
                    under 18
                  </Label>
                </div>
              </div>
          ...
          <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
            <div className="flex items-start gap-2">
              ...
              <p className="text-sm text-blue-700 dark:text-blue-300">
                ...
                cutting the edges. Upload documents using these formats: JPEG,
                HEIC, PDF. Files will automatically be deleted in 30 days.
              </p>
            </div>
          </div>
      ...
      {redirect && !["", "background-check", "license"].includes(redirect) && (
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 shadow-sm">
          <Button
            variant="ghost"
            onClick={handleBack}
