  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
       <Button onClick={()=>{router.back()}} className="text-emerald-600 dark:text-emerald-500 my-4" variant={"outline"}>Back</Button>
            ...
            <div className="flex-1">
              <div className="flex flex-col sm:flex-row sm:justify-between gap-4">
                <div className="flex-1 min-w-0">
                  <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">Irfan I.</h1>
                ...
                <div className="flex flex-col sm:flex-row sm:items-start gap-2 w-full sm:w-auto">
                  ...
                  <Button size="sm" className="flex-1 sm:flex-none bg-emerald-600 hover:bg-emerald-700 dark:bg-emerald-500 dark:hover:bg-emerald-600" asChild>
              ...
              <div className="mt-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
                <div className="flex flex-col sm:flex-row items-start gap-3">
                  ...
                  <Button size="sm" className="bg-green-600 hover:bg-green-700 dark:bg-green-500 dark:hover:bg-green-600 mt-2 sm:mt-0">
                    →
                  </Button>
                </div>
              </div>
          ...
          <div className="w-full lg:w-2/3 space-y-8">
            ...
            <Card className="bg-white dark:bg-gray-900">
              <CardContent className="p-4 sm:p-6 relative">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white leading-snug mb-4">
            ...
            <Card className="bg-white dark:bg-gray-900">
              <CardContent className="p-4 sm:p-6">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <Plus className="h-5 w-5 text-emerald-600 dark:text-emerald-500 cursor-pointer" />
                </div>
                ...
                <div className="text-center py-8 sm:py-12">
                  <div className="w-16 h-16 sm:w-24 sm:h-24 mx-auto bg-orange-100 dark:bg-orange-900/20 rounded-lg flex items-center justify-center mb-4">
                    <Briefcase className="h-8 w-8 sm:h-12 sm:w-12 text-orange-600 dark:text-orange-400" />
                  </div>
                  <Button variant="link" className="text-blue-600 dark:text-blue-400">
                    Add a project.
                  </Button>
                  <p className="text-gray-600 dark:text-gray-400 text-sm mt-1">
                    Talent are hired 5x more often if theyve published a portfolio.
                  </p>
                </div>
              </CardContent>
            </Card>
          ...
          <Card className="bg-white dark:bg-gray-900">
            ...
            <CardContent className="p-4 sm:p-6">
              {certifications.map((cert, index) => (
                <div
                  key={index}
                  className="flex flex-col sm:flex-row items-start gap-4 p-4 border border-gray-200 dark:border-gray-700 rounded-lg mb-4 last:mb-0"
                >
