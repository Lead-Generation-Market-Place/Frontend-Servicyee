...
import ProfessionalList from '@/components/home-services/professional/ProfessionalList';
import ProfessionalFilters from '@/components/home-services/professional/ProfessionalFilters';
import QuotationForm from '@/components/home-services/professional/QuotationForm';
import Breadcrumbs from '@/components/home-services/Breadcrumbs';


export default function ProfessionalPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params);
  ...
  const [expandedFilter, setExpandedFilter] = useState<string | null>(null);
    ...
    const ProfessionalDetails = [
    {
      ...
      status: 'Available',
      description: 'Professional cleaning services with eco-friendly products and guaranteed satisfaction.'
    },
    {
      id: 2,
      ...
      background_check: true,
      status: 'Available',
      description: 'Brightening your home with top-quality cleaning and maintenance services.'
    },
    {
      id: 3,
      ...
      background_check: true,
      status: 'Available',
      description: 'Building maintenance and cleaning specialists with over a decade of experience.'
    },
    {
      id: 4,
      ...
      background_check: true,
      status: 'Available',
      description: 'Sustainable cleaning solutions for environmentally conscious homeowners.'
    },
  ];
